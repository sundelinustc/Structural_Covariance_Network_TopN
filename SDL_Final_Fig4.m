...
legend('PTSD & Depression','PTSD & No-Depression','No-PTSD & Depression','Controls','FontName', 'Arial','FontSize',16);
box off
...
savefig(fullfile(SDL.out,'Figure 4.fig'));
