...
fn = fullfile(SDL.out,SDL.data_type{1},['Data_SC_',SDL.data_type{1},'_',SDL.ana_type{1},'_',SDL.XYM{4},'.mat']);
...
savefig(fullfile(SDL.out,SDL.data_type{1},['Results_Whole_PTSD_vs_CONT',SDL.data_type{1},'_',SDL.ana_type{1},'.fig']));
...
%% save results
fn = fullfile(SDL.out,SDL.data_type{1},['Results_Whole_PTSD_vs_CONT',SDL.data_type{1},'_',SDL.ana_type{1},'.mat']);
