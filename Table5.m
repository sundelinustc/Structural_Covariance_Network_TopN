...
% calculate values for Table 5, which is to show the PTSD x gender interaction.
...
%% Parameters
SDL.data_type = {'CT_Gender';'SA_Gender'}; % 2 types of data
